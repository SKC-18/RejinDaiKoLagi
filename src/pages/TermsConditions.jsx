  ...
  return (
    <div>
      ...
      <p>
        ...
        of Auction House's Website, located at
        https://auction-house-4924a.web.app/?fbclid=IwAR2u_HSmJC1uRZu5-GYB-bJ5o_BIgX_AZYKpV91MkM7GLE7dJlJl8K.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Auction House if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Auction House, you agreed to
        use cookies in agreement with the Auction House's Privacy Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Auction House and/or its licensors own the
        intellectual property rights for all material on Auction House. All
        intellectual property rights are reserved. You may access this from
        Auction House for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        were created with the help of the Saakar K.C and Dikshya Poudel.
      </p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Auction House does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Auction House,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Auction House shall not be
      ...
      <p>
        Auction House reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Auction House a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Auction House; and (d) the link
      ...
      <p>
        ...
        e-mail to Auction House. Please include your name, your organization
      ...
      <p>
        No use of Auction House's logo or other artwork will be allowed for
